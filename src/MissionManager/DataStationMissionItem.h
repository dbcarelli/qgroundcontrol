...
#ifndef DataStationComplexItem_H
#define DataStationComplexItem_H
...
class DataStationMissionItem : public ComplexMissionItem
{
    Q_OBJECT

public:
    DataStationMissionItem(Vehicle* vehicle, QObject* parent = NULL);

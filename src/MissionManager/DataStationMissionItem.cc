...
const char* DataStationMissionItem::jsonComplexItemTypeValue = "fwLandingPattern";

const char* DataStationMissionItem::loiterToLandDistanceName = "LandingDistance";
const char* DataStationMissionItem::landingHeadingName =       "LandingHeading";
const char* DataStationMissionItem::loiterAltitudeName =       "LoiterAltitude";
const char* DataStationMissionItem::loiterRadiusName =         "LoiterRadius";
const char* DataStationMissionItem::landingAltitudeName =      "LandingAltitude";
const char* DataStationMissionItem::glideSlopeName =           "GlideSlope";

const char* DataStationMissionItem::_jsonLoiterCoordinateKey =         "loiterCoordinate";
const char* DataStationMissionItem::_jsonLoiterRadiusKey =             "loiterRadius";
const char* DataStationMissionItem::_jsonLoiterClockwiseKey =          "loiterClockwise";
const char* DataStationMissionItem::_jsonLandingCoordinateKey =        "landCoordinate";
const char* DataStationMissionItem::_jsonValueSetIsDistanceKey =       "valueSetIsDistance";
const char* DataStationMissionItem::_jsonAltitudesAreRelativeKey =     "altitudesAreRelative";

// Usage deprecated
const char* DataStationMissionItem::_jsonFallRateKey =                 "fallRate";
const char* DataStationMissionItem::_jsonLandingAltitudeRelativeKey =  "landAltitudeRelative";
const char* DataStationMissionItem::_jsonLoiterAltitudeRelativeKey =   "loiterAltitudeRelative";

DataStationMissionItem::DataStationMissionItem(Vehicle* vehicle, QObject* parent)
...
//    , _valueSetIsDistance       (true)
{
    ...
    connect(&_loiterAltitudeFact,       &Fact::valueChanged,                                    this, &DataStationMissionItem::_updateLoiterCoodinateAltitudeFromFact);
    connect(&_landingAltitudeFact,      &Fact::valueChanged,                                    this, &DataStationMissionItem::_updateLandingCoodinateAltitudeFromFact);

    connect(&_landingDistanceFact,      &Fact::valueChanged,                                    this, &DataStationMissionItem::_recalcFromHeadingAndDistanceChange);
    connect(&_landingHeadingFact,       &Fact::valueChanged,                                    this, &DataStationMissionItem::_recalcFromHeadingAndDistanceChange);

    connect(&_loiterRadiusFact,         &Fact::valueChanged,                                    this, &DataStationMissionItem::_recalcFromRadiusChange);
    connect(this,                       &DataStationMissionItem::loiterClockwiseChanged,        this, &DataStationMissionItem::_recalcFromRadiusChange);

    connect(this,                       &DataStationMissionItem::loiterCoordinateChanged,       this, &DataStationMissionItem::_recalcFromCoordinateChange);
    connect(this,                       &DataStationMissionItem::landingCoordinateChanged,      this, &DataStationMissionItem::_recalcFromCoordinateChange);

    connect(&_glideSlopeFact,           &Fact::valueChanged,                                    this, &DataStationMissionItem::_glideSlopeChanged);

    connect(&_loiterAltitudeFact,       &Fact::valueChanged,                                            this, &DataStationMissionItem::_setDirty);
    connect(&_landingAltitudeFact,      &Fact::valueChanged,                                            this, &DataStationMissionItem::_setDirty);
    connect(&_landingDistanceFact,      &Fact::valueChanged,                                            this, &DataStationMissionItem::_setDirty);
    connect(&_landingHeadingFact,       &Fact::valueChanged,                                            this, &DataStationMissionItem::_setDirty);
    connect(&_loiterRadiusFact,         &Fact::valueChanged,                                            this, &DataStationMissionItem::_setDirty);
    connect(this,                       &DataStationMissionItem::loiterCoordinateChanged,          this, &DataStationMissionItem::_setDirty);
    connect(this,                       &DataStationMissionItem::landingCoordinateChanged,         this, &DataStationMissionItem::_setDirty);
    connect(this,                       &DataStationMissionItem::loiterClockwiseChanged,           this, &DataStationMissionItem::_setDirty);
    connect(this,                       &DataStationMissionItem::altitudesAreRelativeChanged,      this, &DataStationMissionItem::_setDirty);

    connect(this,                       &DataStationMissionItem::altitudesAreRelativeChanged,      this, &DataStationMissionItem::coordinateHasRelativeAltitudeChanged);
    connect(this,                       &DataStationMissionItem::altitudesAreRelativeChanged,      this, &DataStationMissionItem::exitCoordinateHasRelativeAltitudeChanged);
}

int DataStationMissionItem::lastSequenceNumber(void) const
{
    // land start, loiter, land
    return _sequenceNumber + 2;
}

void DataStationMissionItem::setDirty(bool dirty)
{
    if (_dirty != dirty) {
        _dirty = dirty;
...
void DataStationMissionItem::save(QJsonArray&  missionItems)
{
...
void DataStationMissionItem::setSequenceNumber(int sequenceNumber)
{
...
bool DataStationMissionItem::load(const QJsonObject& complexObject, int sequenceNumber, QString& errorString)
{
...
double DataStationMissionItem::greatestDistanceTo(const QGeoCoordinate &other) const
{
    return qMax(_loiterCoordinate.distanceTo(other),_landingCoordinate.distanceTo(other));
}

bool DataStationMissionItem::specifiesCoordinate(void) const
{
    return true;
}

void DataStationMissionItem::appendMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
...
bool DataStationMissionItem::scanForItem(QmlObjectListModel* visualItems, Vehicle* vehicle)
{
    ...
    DataStationMissionItem* complexItem = new DataStationMissionItem(vehicle, visualItems);
...
double DataStationMissionItem::complexDistance(void) const
{
    return _loiterCoordinate.distanceTo(_landingCoordinate);
}

void DataStationMissionItem::setLandingCoordinate(const QGeoCoordinate& coordinate)
{
...
void DataStationMissionItem::setLoiterCoordinate(const QGeoCoordinate& coordinate)
{
...
double DataStationMissionItem::_mathematicAngleToHeading(double angle)
{
...
double DataStationMissionItem::_headingToMathematicAngle(double heading)
{
    return heading - 90 * -1;
}

void DataStationMissionItem::_recalcFromRadiusChange(void)
{
    // Fixed:
    //      land
    //      loiter tangent
...
void DataStationMissionItem::_recalcFromHeadingAndDistanceChange(void)
{
    // Fixed:
    //      land
    //      heading
...
QPointF DataStationMissionItem::_rotatePoint(const QPointF& point, const QPointF& origin, double angle)
{
    QPointF rotated;
...
void DataStationMissionItem::_recalcFromCoordinateChange(void)
{
    // Fixed:
    //      land
    //      loiter
...
void DataStationMissionItem::_updateLoiterCoodinateAltitudeFromFact(void)
{
    _loiterCoordinate.setAltitude(_loiterAltitudeFact.rawValue().toDouble());
    emit loiterCoordinateChanged(_loiterCoordinate);
    emit coordinateChanged(_loiterCoordinate);
...
void DataStationMissionItem::_updateLandingCoodinateAltitudeFromFact(void)
{
    _landingCoordinate.setAltitude(_landingAltitudeFact.rawValue().toDouble());
    emit landingCoordinateChanged(_landingCoordinate);
}

void DataStationMissionItem::_setDirty(void)
{
    setDirty(true);
}

void DataStationMissionItem::applyNewAltitude(double newAltitude)
{
    _loiterAltitudeFact.setRawValue(newAltitude);
}

void DataStationMissionItem::_glideSlopeChanged(void)
{
    if (!_ignoreRecalcSignals) {
...
void DataStationMissionItem::_calcGlideSlope(void)
{
    double landingAltDifference = _loiterAltitudeFact.rawValue().toDouble() - _landingAltitudeFact.rawValue().toDouble();
